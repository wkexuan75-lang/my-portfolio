...
export function HomeView() {
  ...
  return (
    <motion.div
      className="relative flex min-h-0 w-full flex-1 flex-col overflow-hidden bg-[#050505] font-sans"
    ...
    >
      ...
      {/* FAB: absolute to this screen root (inside PhoneFrame scroll area), not the page viewport */}
